...
void solve()
{
    ...
    else
    {
        ...
        b.pb(a);
        auto c = a;
        rotate(c.begin(), c.begin() + c.size() / 2 + 1, c.end());
        b.pb(c);
        auto sum = b[0].back() + b[1].back() + 1;
        vi d;
        fo(i, n)
        {
            d.pb(sum - b[0][i] - b[1][i]);
        }
        b.pb(d);
        next_permutation(all(a));
        k -= 3;
        ...
        {
            auto a_back = back(a);
            if (a != b[0] && a != b[1] && a != b[2] && a_back != b[0] && a_back != b[1] && a_back != b[2])
            {
                b.pb(a);
                b.pb(a_back);
                k -= 2;
