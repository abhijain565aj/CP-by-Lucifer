...
void solve()
{
    ...
    // {
    //     debug(c);
    //     auto v = c.lower_bound(a[i][1]); // logm
    //     vi temp;
    //     vi erase;
    //     while (v != c.end()) // worstcase m
    //     {

    //         int cns = 2 * ((*v - a[i][1]) / a[i][0]) + 2;
    //         temp.pb(*v - (cns / 2) * a[i][0]);
    //         erase.pb(*v); // log m
    //         v++;
    //         ans += cns;
    //         debug(ans);
    //     }
    //     for (auto x : erase) // worstcase m
    //     {
    //         c.erase(x); // log m
    //     }
    //     for (auto x : temp) // worscase m
    //     {
    //         c.insert(x); // log m
    //     }
    // }
