...
vvl matmul(vvl& A, vvl& B){
    vvl R(2,vl(2));
    R[0][0] = add(mul(A[0][0],B[0][0]),mul(A[0][1],B[1][0]));
    R[0][1] = add(mul(A[0][0],B[0][1]),mul(A[0][1],B[1][1]));
    R[1][0] = add(mul(A[1][0],B[0][0]),mul(A[1][1],B[1][0]));
    R[1][1] = add(mul(A[1][0],B[0][1]),mul(A[1][1],B[1][1]));
    return R;
}
int main()
{
